...
from app.notes.schemas import NoteCreate, NoteUpdate, NooteOut, NotePatch
from typing import List

app = FastAPI()

@app.post("/notes", response_model=NooteOut)
